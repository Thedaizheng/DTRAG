...
class DBChroma:
    def __init__(self):
        ...
        self.client = chromadb.PersistentClient(path=r"E:\DTRAG\DTRAG_DEEPSEEK_ADA\rag_db")  # 移除 path 参数
    ...
    def _get_embeddings(self, embedding_input):
        client = openai.OpenAI(base_url = "http://chatapi.littlewheat.com/v1",api_key=os.getenv("OPENAI_API_KEY"))
...
def init_db():
    ...
    client = PersistentClient(path=r"E:\DTRAG\DTRAG_DEEPSEEK_ADA\rag_db")  # 指定存储路径
