...
class DBChroma:
    def __init__(self):
        ...
        self.client = chromadb.PersistentClient(path=r"E:\DTRAG\DTRAG_CLAUDE_ADA\rag_db")  # 移除 path 参数
...
def init_db():
    ...
    client = PersistentClient(path=r"E:\DTRAG\DTRAG_CLAUDE_ADA\rag_db")  # 指定存储路径
